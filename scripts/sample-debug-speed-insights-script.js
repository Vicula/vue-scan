      ...
      (c = function () {
        ...
        (w = function (e) {
          'hidden' === document.visibilityState &&
            E > -1 &&
            ((E = 'visibilitychange' === e.type ? e.timeStamp : 0), M());
        }),
        (C = function () {
            ...
            F(
              b(function () {
                var e,
                  ...
                  u = g('layout-shift', o);
                u &&
                  ((e = y(n, t, k, r.reportAllChanges)),
                  S(function () {
                    o(u.takeRecords()), e(!0);
                  }),
                  m(function () {
                    (i = 0),
                      (e = y(n, (t = h('CLS', 0)), k, r.reportAllChanges)),
                      T(function () {
                        return e();
                      });
                  }),
        ...
        (q = function (e, t) {
          r ||
            ((r = t), (i = e), (a = new Date()), V(removeEventListener), N());
        }),
        (N = function () {
          if (i >= 0 && i < a - R) {
            var e = {
          ...
          if (e.cancelable) {
            ...
            'pointerdown' == e.type
              ? ((t = function () {
                ...
                (r = function () {
                  removeEventListener('pointerup', t, B),
                    removeEventListener('pointercancel', n, B);
                }),
                addEventListener('pointerup', t, B),
                addEventListener('pointercancel', n, B))
              : q(i, e);
          }
        }),
        (V = function (e) {
          ...
          (t = t || {}),
            I(function () {
              ...
              (n = y(e, u, O, t.reportAllChanges)),
                ...
                l &&
                  m(function () {
                    (n = y(e, (u = h('FID')), O, t.reportAllChanges)),
                      (o = []),
                      (i = -1),
                      (r = null),
                      V(addEventListener),
        ...
        (G = function (e) {
          e.forEach(function (e) {
            e.interactionId &&
              ...
              (_ = (z = Math.max(z, e.interactionId)) ? (z - j) / 7 + 1 : 0));
          });
        }),
        (J = function () {
          return u ? _ : performance.interactionCount || 0;
        }),
        (K = function () {
  ...
  t(() => {
    el(),
      ...
      (function () {
        ...
        function u(e, ...t) {
          (null == r ? void 0 : r.dataset.debug) !== 'false' &&
            console.log(
              `%c[Vercel Speed Insights]%c ${e}`,
        ...
        (() => {
          ...
          if (i < 0 || i > 1)
            throw Error(
              'Sample rate must be between 0 and 1. Example: 0.6 will send 60% of the requests.',
            );
          if (!(1 === i || Math.random() <= i)) {
            u(
              'Sample rate is not met, skipping vitals collection for this page load',
            );
            return;
          }
          ev((t) => {
